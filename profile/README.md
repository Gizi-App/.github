...
## 🎯 Purpose 🎯
Early detection and prevention of stunting and wasting in children during the critical first 1,000 days of life.

## ⚙️ Features ⚙️
- On-device stunting & wasting diagnosis.
- Maternal Health risk diagnosis.
- Personalized nutrition guidance with AI chatbot.
- Educational Health Article

## 🏆 Goal 🏆
Empower parents with actionable insights to ensure healthier child growth and development. Action and prevention of stunting and wasting in children during the critical first 1,000 days of life.

---

# 🛑 Problem Statement 🛑
Stunting and wasting are major issues that hinder the growth and development of children in Indonesia. According to the 2023 Indonesian Health Survey (Survei Kesehatan Indonesia), the prevalence of stunting in Indonesia is 21.5%, while wasting is at 8.5%. These conditions are a significant concern for the government, given their adverse impact on children's cognitive abilities in the future, particularly during the first 1,000 days of life, a critical period for optimal growth and development.
...
<p align="center">
  <a>
    <img alt="Gizi" title="Gizi" src="Why Gizi.png">
  </a>
</p>
Gizi is designed to solve the exact problems we just discussed. Here’s how Gizi tackles each challenge:

- Diagnostic System: GIZI allows families to detect stunting and wasting risks using basic measurements like height, weight, and age directly on their devices, even offline, making it accessible to families in remote areas.
- Nutri AI Chatbot: The 24/7 AI-powered chatbot provides personalized nutrition advice, helping parents make informed decisions based on their child's needs and local food availability.
- Educational Health Articles: GIZI offers simple, actionable articles to educate families on nutrition and health, guiding them on practical steps to support their child's growth and well-being.

In short, Gizi bridges the gap in healthcare access and education. It combines early detection, personalized guidance, and continuous learning to empower families across Indonesia to take charge of their children’s health and ensure a brighter future.
...
# 👩‍💻 Meet the Team Behind Gizi 👨‍💻
Gizi is made possible by a dedicated team of passionate and skilled individuals committed to addressing stunting and wasting in Indonesia. Each member brings expertise from their respective fields, combining efforts to create this impactful solution:
...
![TensorFlow Lite](https://img.shields.io/badge/TensorFlow%20Lite-336633?style=for-the-badge&logo=tensorflow&logoColor=white)
![Kaggle](https://img.shields.io/badge/Kaggle-20BEFF?style=for-the-badge&logo=kaggle&logoColor=white)
![Kaggle Notebook](https://img.shields.io/badge/Kaggle%20Notebook-20BEFF?style=for-the-badge&logo=kaggle&logoColor=white)
![Vertex AI Studio](https://img.shields.io/badge/Vertex%20AI%20Studio-4285F4?style=for-the-badge&logo=google&logoColor=white)
